...
/* harmony import */ var _material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @material-ui/core/CircularProgress */ "./node_modules/@material-ui/core/CircularProgress/index.js");
/* harmony import */ var _material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var rxjs_ajax__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! rxjs/ajax */ "./node_modules/rxjs/_esm5/ajax/index.js");
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      ...
      this.keyup$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_18__["fromEvent"])(this.searchRef.current, 'keyup').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["map"])(function (event) {
        return event.target.value;
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["distinctUntilChanged"])()); // reset

      this.reset$ = this.keyup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["filter"])(function (query) {
        return query.trim().length === 0;
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["tap"])(this.hideLoading)); // should return json data after api call

      this.user$ = this.keyup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["filter"])(function (query) {
        return query.trim().length > 0;
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["tap"])(this.showLoading), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["mergeMap"])(function (query) {
        return rxjs_ajax__WEBPACK_IMPORTED_MODULE_20__["ajax"].getJSON("https://api.github.com/search/users?q=".concat(query));
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["tap"])(this.hideLoading)); // subscribe date to ui rendering
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_7___default.a, {
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_material_ui_icons_Search__WEBPACK_IMPORTED_MODULE_16___default.a, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 137
        },
        ...
        __self: this
      }, this.state.isLoading ? react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_17___default.a, {
...
//# sourceMappingURL=index.js.fe75b3846969aa389683.hot-update.js.map