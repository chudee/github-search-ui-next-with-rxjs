    ...
    value: function componentDidMount() {
      ...
      var _this$keyup$$pipe = this.keyup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["partition"])(function (query) {
        return query.trim().length > 0;
          ...
          reset$ = _this$keyup$$pipe2[1]; // reset
      ...
      this.user$ = user$.pipe( // filter((query: string) => query.trim().length > 0),
...
//# sourceMappingURL=index.js.88d4ef0d29f49937fd82.hot-update.js.map