...
var styles = function styles(theme) {
  return {
    root: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_6__["default"])({}, theme.mixins.gutters(), {
...
function (_Component) {
  ...
  function Index() {
    ...
    _this.searchRef = Object(react__WEBPACK_IMPORTED_MODULE_7__["createRef"])();
    _this.state = {
      isLoading: false,
      userList: []
    };
    ...
    _this.userListItem = function (items) {
      return items.map(function (user) {
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_ListItem__WEBPACK_IMPORTED_MODULE_13___default.a, {
          ...
          __self: this
        }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_ListItemAvatar__WEBPACK_IMPORTED_MODULE_15___default.a, {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 103
          },
          __self: this
        }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_Avatar__WEBPACK_IMPORTED_MODULE_16___default.a, {
          alt: "Remy Sharp",
          src: user.avatar_url,
          __source: {
            fileName: _jsxFileName,
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$keyup$$pipe = this.keyup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["partition"])(function (query) {
        return query.trim().length > 0;
          ...
          reset$ = _this$keyup$$pipe2[0],
          user$ = _this$keyup$$pipe2[1]; // reset


      reset$ = keyup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["filter"])(function (query) {
        return query.trim().length === 0;
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["tap"])(this.hideLoading)); // should return json data after api call

      user$ = keyup$.pipe( // filter((query: string) => query.trim().length > 0),
      Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["tap"])(this.showLoading), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_20__["mergeMap"])(function (query) {
      ...
      user$.subscribe(function (v) {
        _this2.setState({
          userList: v.items.length > 0 ? _this2.userListItem(v.items) : _this2.userNoItem()
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_8___default.a, {
        style: classes.root,
        elevation: 1,
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_9___default.a, {
        container: true,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 133
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_InputBase__WEBPACK_IMPORTED_MODULE_11___default.a, {
        ...
        __self: this
      }), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_IconButton__WEBPACK_IMPORTED_MODULE_10___default.a, {
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_icons_Search__WEBPACK_IMPORTED_MODULE_17___default.a, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 141
        },
        ...
        __self: this
      }, this.state.isLoading ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_material_ui_core_CircularProgress__WEBPACK_IMPORTED_MODULE_18___default.a, {
...
//# sourceMappingURL=index.js.c7b6f42fb6275c52aed9.hot-update.js.map