...
function (_Component) {
  ...
  function Index() {
    ...
    _this.user$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_20__["fromEvent"])(_this.searchRef.current, 'keyup').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["map"])(function (event) {
      return event.target.value;
    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["filter"])(function (query) {
      return query.trim().length > 0;
    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["mergeMap"])(function (query) {
    ...
    _this.drawLayer = function (items) {
      return items.map(function (user) {
        return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core_ListItem__WEBPACK_IMPORTED_MODULE_14___default.a, {
          ...
          __self: this
        }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core_ListItemAvatar__WEBPACK_IMPORTED_MODULE_16___default.a, {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 85
          },
          ...
          primary: "Oui Oui",
          secondary: react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_18___default.a, {
            component: "span",
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Index, [{
    ...
    //ajax.getJSON(`https://github.com/search?q=${query}&type=Users`)),
    value: function componentDidMount() {
      this.user$.subscribe(function (v) {
        console.log(v); // this.test = this.drawLayer(v.items);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_9___default.a, {
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_material_ui_icons_Search__WEBPACK_IMPORTED_MODULE_19___default.a, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 113
        },
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                req = _ref.req;
                user$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_20__["fromEvent"])(this.searchRef.current, 'keyup').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["map"])(function (event) {
                  return event.target.value;
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["filter"])(function (query) {
                  return query.trim().length > 0;
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_21__["mergeMap"])(function (query) {
...
//# sourceMappingURL=index.js.488505316cbb4835f74f.hot-update.js.map